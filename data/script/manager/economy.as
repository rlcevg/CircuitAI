...
void UpdateEconomy()
{
	...
	aiEconomyMgr.isEnergyEmpty = energy.current < energy.storage * 0.25f;
...
//	aiEconomyMgr.isEnergyStalling = (energy.income < energy.pull) && (energy.current < energy.storage * 0.5f);
	aiEconomyMgr.isEnergyStalling = aiEconomyMgr.isEnergyEmpty || ((energy.income < energy.pull) && (energy.current < energy.storage * 0.7f));
}
