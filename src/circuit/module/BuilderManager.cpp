...
{
	// FIXME: DEBUG
	circuit->LOG("ai: %i | buildTasksCount: %i | workerSize*8: %i | buildType: %i", circuit->GetSkirmishAIId(), buildTasksCount, workers.size()*8, static_cast<IBuilderTask*>(unit->GetTask())->GetBuildType());
	// FIXME: DEBUG
