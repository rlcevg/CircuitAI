...
struct SBlockingMap {
	enum class StructType: int {FACTORY = 0, MEX, ENERGY, PYLON, DEF_LOW, DEF_MID, DEF_HIGH, SPECIAL, NANO, UNKNOWN, TOTAL_COUNT};
	enum class StructMask: int {FACTORY = 0x0001,     MEX = 0x0002,   ENERGY = 0x0004,   PYLON = 0x0008,
								DEF_LOW = 0x0010, DEF_MID = 0x0020, DEF_HIGH = 0x0040, SPECIAL = 0x0080,
								   NANO = 0x0100, UNKNOWN = 0x0200,     NONE = 0x0000,     ALL = 0xFFFF};
