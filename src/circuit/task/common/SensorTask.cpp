...
ISensorTask::ISensorTask(ITaskModule* mgr, Priority priority, std::function<bool (CCircuitDef*)> isSensor,
...
ISensorTask::ISensorTask(ITaskModule* mgr, std::function<bool (CCircuitDef*)> isSensor, BuildType buildType)
